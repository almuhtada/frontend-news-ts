  ...
  if (items.length === 0) {
    return (
      <div className="space-y-6">
        <h3 className="text-lg font-bold text-gray-900 mb-4 border-b-2 border-emerald-600 pb-1">
          Terpopuler
        </h3>
  ...
  return (
    <div className="space-y-6">
      ...
      {items.slice(0, 5).map((item, index) => {
        const imageUrl = item.featured_image || PLACEHOLDER_IMAGE_SMALL;
          ...
          >
            {index === 0 ? (
              ...
              <div className="relative bg-white rounded-lg overflow-hidden hover:shadow-lg transition">
                ...
                />
                <div className="p-4">
                  <h4 className="text-base font-semibold text-gray-900 line-clamp-2 group-hover:text-emerald-700 transition">
                    {item.title}
                  </h4>
              ...
              <div className="flex items-center justify-between text-gray-600 mt-3 hover:text-emerald-700 transition">
