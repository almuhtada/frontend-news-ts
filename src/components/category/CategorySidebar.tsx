            ...
            categories.map((category, index) => (
              ...
              >
                <div className="flex items-baseline min-w-0">
                  ...
                  <h4 className="font-bold text-sm text-gray-805 dark:text-gray-200 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors truncate">
                    {category.name}
                  </h4>
                </div>
                <ChevronRight className="w-3.5 h-3.5 text-gray-300 dark:text-gray-650 group-hover:text-emerald-500 dark:group-hover:text-emerald-400 transition-colors" />
              </a>
            ))
          ) : (
