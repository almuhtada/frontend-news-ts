import { Flame as Fire, ChevronRight, Users } from "lucide-react";
            ...
            <div className="divide-y divide-gray-50 dark:divide-gray-800">
               {hotTopics.map((topic, index) => (
                 <a
                   ...
                   className="group flex items-center justify-between px-4 py-3.5 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800/60 transition-all duration-200"
                 >
                   <div className="flex items-center gap-3 min-w-0">
                     ...
                     <div className="min-w-0">
                       <h4 className="font-medium text-gray-700 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-gray-100 transition-colors truncate">
                         {topic.name}
                       </h4>
          ...
          {[
            ...
            >
              ...
              <div className="relative z-10">
                <div className="mb-3 opacity-90">{social.icon}</div>
