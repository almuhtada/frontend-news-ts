      ...
      <div className="relative w-full max-w-2xl rounded-2xl bg-white p-6 shadow-2xl">
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            className="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20"
            rows={6}
          />
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 rounded-lg border border-gray-300 bg-white px-4 py-2.5 font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50"
          >
            Batal
          </button>
          <button
