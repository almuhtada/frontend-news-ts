            ...
            {categories.map((category, index) => (
              ...
              >
                <div className="flex items-baseline min-w-0">
                  ...
                  <span className="font-bold text-sm text-gray-850 dark:text-gray-200 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors truncate">
                    {category}
                  </span>
                </div>
                <ChevronRight className="flex-shrink-0 w-3.5 h-3.5 text-gray-300 dark:text-gray-650 group-hover:text-emerald-500 dark:group-hover:text-emerald-400 group-hover:translate-x-0.5 transition-all duration-200" />
              </button>
            ))}
          </div>
        ) : (
